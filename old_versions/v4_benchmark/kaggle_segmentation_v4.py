# ============================================================
# AI Healthcare Hackathon 2026 — V4 Kaggle Segmentation
# ============================================================
...
class CFG:
    ...
    MODEL_SAVE_DIR = "segmentation_v4"
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"  🚀 V4 Kaggle Segmentation")
    ...
    for epoch in range(1, CFG.EPOCHS + 1):
        ...
        if val_iou > best_iou:
            best_iou = val_iou
            # DataParallel model handle
            state_dict = model.module.state_dict() if isinstance(model, nn.DataParallel) else model.state_dict()
            torch.save(state_dict, os.path.join(CFG.MODEL_SAVE_DIR, "best_model.pth"))
